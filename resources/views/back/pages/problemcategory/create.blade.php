...
@section('content')
 ...
 <div id="page-wrapper">
        ...
        <form action="{{route('problemcategory.store')}}" method="post"  enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Enter problem" required>
                            </div>
                        </div>
