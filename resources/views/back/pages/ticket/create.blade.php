        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-success">
                    ...
                    <form action="{{ route('ticket.store') }}" name="createTicketForm" id="createTicketForm" class="dropzone" method="post" enctype="multipart/form-data">
                        @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select name="problem_type_id" class="form-control select2 ">
                                                        ...
                                                        @endforeach
                                                        @if ($errors->has('problem_type_id'))
                                                        <span class="error text-danger">
                                                            {{ $errors->first('problem_type_id') }}</span>
                                                        @endif
                                                    </select>
