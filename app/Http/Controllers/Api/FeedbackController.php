...
class FeedbackController extends Controller
{
    ...
    {
        if (empty($request->organization_id) || empty($request->representative_name) || empty($request->feedback) || empty($request->image) || empty($request->signature_image) || empty($request->latitude) || empty($request->longitude)) {
            return response([
                'success' => false,
